...
- Production docs live in `README.md`, `docs/product-blueprint-v1.md`, `docs/production-app-roadmap.md`, and `docs/agent-handoff.md`.
- Before starting feature work, read `docs/production-app-roadmap.md` and identify the roadmap slice being advanced.
